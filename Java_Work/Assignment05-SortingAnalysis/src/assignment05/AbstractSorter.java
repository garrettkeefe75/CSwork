 ...
 */
public abstract class AbstractSorter<T extends Comparable<? super T>> implements Sorter<T>
{
	...
	public void setThreshold(int threshold) throws UnsupportedOperationException
	{
		...
		throw new UnsupportedOperationException("This operation is not supported by " + this.name());
	}

...
(define-type ExpI
  ...
  (if0I [test-expr : ExpI]
        [then-expr : ExpI]
        [else-expr : ExpI])
  (newarrayI [type : Symbol]
             [size : ExpI]
             [elem : ExpI])
  (arrayrefI [array : ExpI]
             [index : ExpI])
  (arraysetI [array : ExpI]
             [index : ExpI]
             [elem : ExpI]))
  ...
  (local [(define (recur expr)
    ...
    (type-case ExpI a
      ...
      [(arrayrefI array index)
       (arrayrefE (recur array)
                  (recur index))]
      [(arraysetI array index elem)
       (arraysetE (recur array)
                  (recur index)
                  (recur elem))])))
...
(module+ test
  (test (exp-i->c (numI 10) 'Object)
        (numE 10))
  (test (exp-i->c (letI 'x (numI 10) (idI 'x)) 'Object)
        (letE 'x (numE 10) (idE 'x)))
  (test (exp-i->c (nulI) 'Object)
        (nulE))
  ...
  (test (exp-i->c (if0I (numI 1) (plusI (numI 1) (numI 2)) (plusI (numI 0) (numI 3))) 'Object)
        (if0E (numE 1) (plusE (numE 1) (numE 2)) (plusE (numE 0) (numE 3))))
  (test (exp-i->c (newarrayI 'num (numI 5) (numI 10)) 'Object)
        (newarrayE 'num (numE 5) (numE 10)))
  (test (exp-i->c (arrayrefI (newarrayI 'num (numI 5) (numI 10)) (numI 4)) 'Object)
        (arrayrefE (newarrayE 'num (numE 5) (numE 10)) (numE 4)))
  (test (exp-i->c (arraysetI (newarrayI 'num (numI 5) (numI 10)) (numI 4) (numI 32)) 'Object)
        (arraysetE (newarrayE 'num (numE 5) (numE 10)) (numE 4) (numE 32))))

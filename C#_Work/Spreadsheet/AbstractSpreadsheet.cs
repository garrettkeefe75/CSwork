...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        ///   This method is designed to visit all of the direct dependencies of the cell with the name <param>"name"</param>
        ///   it then visits each of the dependents dependents and adds them to the changed list. It will continue this until 
        ///   all of the dependencies are added to the changed list and returned in the GetCellToRecalculate method.
        ///   
        /// Will also throw a circular exception if the starting cell is ever found within its dependencies.
        /// </summary>
